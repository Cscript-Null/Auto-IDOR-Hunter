...
class ProxyThread(threading.Thread):
    ...
    def handle_http(self, request, method, path, version):
        ...
        # Parse HTTP response headers to check for JavaScript content
        ...
        # Perform regex matching on the response body if needed (existing functionality)
        # For the purpose of this modification, this part can be left as is or removed
        # depending on whether you still need regex pattern matching.
